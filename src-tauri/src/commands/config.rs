...
pub async fn get_official_providers() -> Result<Vec<OfficialProvider>, String> {
    info!("[ClawGate Provider] 获取 ClawGate 预设列表...");

    let providers = vec![
        OfficialProvider {
            id: "clawgate-claude".to_string(),
            name: "ClawGate Claude".to_string(),
            icon: "🟣".to_string(),
            default_base_url: Some("https://xiaoclaw.com/v1".to_string()),
            api_type: "anthropic-messages".to_string(),
            requires_api_key: true,
            docs_url: Some("https://xiaoclaw.com/docs.html".to_string()),
            suggested_models: vec![
                SuggestedModel {
                    id: "claude-opus-4-6".to_string(),
                    name: "Claude Opus 4.6".to_string(),
                    description: Some("最新旗舰，最强推理".to_string()),
                ...
                SuggestedModel {
                    ...
                    name: "Claude Opus 4.6 (20260205)".to_string(),
                    description: Some("指定版本".to_string()),
                    context_window: Some(200000),
                    max_tokens: Some(64000),
                    recommended: false,
                },
                SuggestedModel {
                    ...
                    description: Some("上一代旗舰".to_string()),
                    context_window: Some(200000),
                    max_tokens: Some(64000),
                    recommended: false,
                },
                SuggestedModel {
                    id: "claude-opus-4-1-20251101".to_string(),
                    name: "Claude Opus 4.1".to_string(),
                    description: Some("经典稳定版".to_string()),
                    context_window: Some(200000),
                    max_tokens: Some(64000),
                    recommended: false,
                },
                SuggestedModel {
                    ...
                    description: Some("性价比之王".to_string()),
                    context_window: Some(200000),
                    max_tokens: Some(64000),
                    recommended: false,
                },
                SuggestedModel {
                    ...
                    description: Some("极速轻量".to_string()),
                    context_window: Some(200000),
                    max_tokens: Some(64000),
                    recommended: false,
                },
        ...
        OfficialProvider {
            id: "clawgate-gpt".to_string(),
            name: "ClawGate GPT".to_string(),
            icon: "🟢".to_string(),
            default_base_url: Some("https://xiaoclaw.com/codex/v1".to_string()),
            ...
            suggested_models: vec![
                SuggestedModel {
                    ...
                    description: Some("最新旗舰".to_string()),
                ...
                SuggestedModel {
                    ...
                    description: Some("增强版".to_string()),
                    context_window: Some(128000),
                    max_tokens: Some(16384),
                    recommended: false,
                },
                SuggestedModel {
                    ...
                    description: Some("代码专精".to_string()),
                    context_window: Some(128000),
                    max_tokens: Some(16384),
                    recommended: false,
                },
                SuggestedModel {
                    ...
                    description: Some("最新代码模型".to_string()),
                    context_window: Some(128000),
                    max_tokens: Some(16384),
                    recommended: false,
                },
        ...
        OfficialProvider {
            id: "clawgate-gemini".to_string(),
            name: "ClawGate Gemini".to_string(),
            icon: "🔵".to_string(),
            default_base_url: Some("https://xiaoclaw.com/gemini_cli/v1beta".to_string()),
            ...
            suggested_models: vec![
                SuggestedModel {
                    ...
                    description: Some("最强推理".to_string()),
                ...
                SuggestedModel {
                    ...
                    description: Some("快速高效".to_string()),
                    context_window: Some(1048576),
                    max_tokens: Some(65536),
                    recommended: false,
                },
                ...
                SuggestedModel {
                    ...
                    description: Some("最新一代".to_string()),
                    context_window: Some(1048576),
                    max_tokens: Some(65536),
                    recommended: false,
                },
                SuggestedModel {
                    id: "gemini-3-flash-lite".to_string(),
                    name: "Gemini 3 Flash Lite".to_string(),
                    description: Some("最新轻量".to_string()),
                    context_window: Some(1048576),
                    max_tokens: Some(65536),
                    recommended: false,
                },
    ...
    info!(
        "[ClawGate Provider] ✓ 返回 {} 个 ClawGate Provider 预设",
        providers.len()
    );
    Ok(providers)
}

...
pub async fn get_official_providers() -> Result<Vec<OfficialProvider>, String> {
    ...
    let providers = vec![
        OfficialProvider {
            ...
            icon: "🟣".to_string(),
            default_base_url: Some("http://43.154.19.196/v1".to_string()),
        ...
        OfficialProvider {
            ...
            icon: "🟢".to_string(),
            default_base_url: Some("http://43.154.19.196/codex/v1".to_string()),
        ...
        OfficialProvider {
            ...
            icon: "🔵".to_string(),
            default_base_url: Some("http://43.154.19.196/gemini_cli/v1beta".to_string()),
